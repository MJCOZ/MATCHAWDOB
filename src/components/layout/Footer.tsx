...
export function Footer() {
  ...
  return (
    <footer style={{ background: "#261B6D", color: "white", borderTop: "3px solid #1a1a1a" }}>
      ...
      {/* خط الكانجي الزخرفي */}
      <div className="overflow-hidden border-b border-[#B2DE81]/10" style={{ borderBottom: "1px solid rgba(178,222,129,0.15)" }}>
        <div className="container-custom py-2.5 flex items-center gap-8 overflow-x-auto scrollbar-hide">
          {["抹茶", "宇宙", "日本", "お茶", "✦", "MATCHA WDOB", "抹茶", "宇宙", "日本", "お茶", "✦", "MATCHA WDOB"].map((k, i) => (
            <span key={i} className={`text-sm font-black opacity-20 whitespace-nowrap flex-shrink-0 ${/[A-Z]/.test(k) ? "font-en tracking-widest" : ""}`}
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <a href={`https://wa.me/${whatsapp}`} target="_blank" aria-label="واتساب"
                ...
                style={{ background: "#25D366", border: "2px solid rgba(255,255,255,0.3)", borderRadius: "4px", boxShadow: "2px 2px 0 rgba(0,0,0,0.3)" }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translate(-1px,-1px)"; (e.currentTarget as HTMLElement).style.boxShadow = "3px 3px 0 rgba(0,0,0,0.3)"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = ""; (e.currentTarget as HTMLElement).style.boxShadow = "2px 2px 0 rgba(0,0,0,0.3)"; }}
              >
              ...
              <a href="#" aria-label="Instagram"
                className="w-10 h-10 flex items-center justify-center transition-all"
                style={{ background: "linear-gradient(135deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)", border: "2px solid rgba(255,255,255,0.3)", borderRadius: "4px", boxShadow: "2px 2px 0 rgba(0,0,0,0.3)" }}
              ...
              <a href="#" aria-label="X / Twitter"
                className="w-10 h-10 flex items-center justify-center transition-all"
                style={{ background: "#000", border: "2px solid rgba(255,255,255,0.3)", borderRadius: "4px", boxShadow: "2px 2px 0 rgba(0,0,0,0.3)" }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translate(-1px,-1px)"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = ""; }}
              >
                <Twitter size={17} />
              ...
              <a href="#" aria-label="TikTok"
                className="w-10 h-10 flex items-center justify-center transition-all"
                style={{ background: "#111", border: "2px solid rgba(255,255,255,0.3)", borderRadius: "4px", boxShadow: "2px 2px 0 rgba(0,0,0,0.3)" }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translate(-1px,-1px)"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = ""; }}
              >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2 flex-wrap justify-center">
              ...
              {["Mada", "Visa", "Mastercard", "Apple Pay", "STC Pay"].map(method => (
                <span key={method} className="font-en text-xs font-black text-[#B2DE81]/80 px-3 py-1"
            ...
            <div className="flex items-center gap-2 flex-wrap justify-center">
              ...
              {["Aramex", "SMSA", "البريد السعودي"].map(carrier => (
                <span key={carrier} className="text-xs font-bold text-[#B2DE81]/80 px-3 py-1"
                  style={{ background: "rgba(53,42,138,0.6)", border: "1px solid rgba(178,222,129,0.2)", borderRadius: "3px" }}>
                  {carrier}
                </span>
              ))}

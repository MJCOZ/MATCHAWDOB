        ...
        {[
          {
            ...
            content: "باستخدامك لموقع MatchaWdob، فإنك توافق على هذه الشروط والأحكام. إذا كنت لا توافق على أي من هذه الشروط، يُرجى عدم استخدام الموقع.",
          },
          {
...
• في حالة عدم توفر المنتج سنتواصل معك فوراً`,
          ...
          },
          {
            ...
            content: "جميع المحتوى على الموقع (الشعارات، الصور، النصوص، الشخصيات) ملك حصري لـ MatchaWdob ومحمي بحقوق الملكية الفكرية. يُحظر أي استخدام بدون إذن كتابي مسبق.",
          },
          {
            title: "تحديد المسؤولية",
            content: "MatchaWdob غير مسؤول عن أي أضرار غير مباشرة تنتج عن استخدام المنتجات خارج نطاق التعليمات المرفقة.",
          },
          {
